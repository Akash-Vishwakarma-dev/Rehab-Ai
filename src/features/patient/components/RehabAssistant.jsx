...
const RehabAssistant = ({ isOpen, onClose, patientProfile }) => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const context = `You are Rehab AI, an expert AI physiotherapy assistant. You provide helpful, accurate, and encouraging advice about rehabilitation, exercises, and recovery.
...
User Question: ${userMessage}`;
            ...
            console.error('[RehabAssistant] Error:', error);
            setMessages(prev => [...prev, {
                role: 'assistant',
            ...
            <div className="relative w-[400px] h-[600px] bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 flex flex-col overflow-hidden animate-in slide-in-from-bottom-5 duration-300">
                ...
                <div className="p-6 bg-slate-900 text-white flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-black leading-none mb-1">Rehab AI</h2>
